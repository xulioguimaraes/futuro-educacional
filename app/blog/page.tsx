...
const latestPosts = [
  {
    ...
    title: "5 Dicas para fazer uma boa redação",
    author: "Prof. Antônio",
    image: "/9dd5674bf9a68060ebe6088dae73de1e4161ba5d.jpg",
  },
  {
    id: 2,
    title: "5 Dicas para fazer uma boa redação",
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <aside className="lg:col-span-1 space-y-6">
              {/* Search */}
              <div className="rounded-lg bg-[#1C437F1A] p-6">
              ...
              <div className="bg-[#1C437F1A] rounded-lg p-6">
                <h3 className="text-[22px] font-semibold text-[#17012C] mb-4">
                  Últimos Posts
                </h3>
                  ...
                  {latestPosts.map((post) => (
                    <div key={post.id} className="flex gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <h4 className=" font-semibold text-[#17012C] line-clamp-2">
                          {post.title}
                        </h4>
                      </div>
                    </div>
              ...
              <div className="bg-[#1C437F1A] rounded-lg p-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {tags.map((tag, index) => (
                    <button
                      key={index}
                      className={`px-3 py-1 rounded-[5px]  font-normal transition-colors ${
                        tag === "ENEM"
                ...
                <div className="space-y-5">
                  {comments.map((comment, index) => (
                    <div key={index} className="flex items-start gap-4">
                      <div className="bg-[#1C437F] rounded-full w-20 h-12 flex items-center justify-center">
                        <svg
                          width="24"
                          height="21"
                          viewBox="0 0 24 21"
                        ...
                        >
                          <path
                            d="M11.8125 20.6249C11.6574 20.6249 11.5021 20.5865 11.3613 20.5092C11.0614 20.3445 10.875 20.0295 10.875 19.6874V17.8125C10.875 17.2956 10.4544 16.875 9.9375 16.875H8.4375C3.78506 16.875 0 13.0899 0 8.4375C0 3.78506 3.78506 0 8.4375 0H15.5625C20.2149 0 24 3.78506 24 8.4375C24 8.47626 23.9998 8.51484 23.9994 8.55333C23.9773 10.826 23.2868 12.5292 21.7609 14.0761C20.3646 15.4916 18.3243 16.75 15.5003 18.4917C14.5493 19.0783 13.4715 19.7431 12.3157 20.4784C12.1626 20.5758 11.9877 20.6249 11.8125 20.6249ZM8.4375 1.875C4.81894 1.875 1.875 4.81894 1.875 8.4375C1.875 12.0561 4.81894 15 8.4375 15H9.9375C11.4883 15 12.75 16.2617 12.75 17.8125V17.9894C13.3751 17.5995 13.9667 17.2347 14.516 16.8959C17.2284 15.2229 19.1882 14.0141 20.4261 12.7594C21.6149 11.5543 22.107 10.3304 22.1245 8.53514C22.1248 8.50275 22.125 8.47017 22.125 8.4375C22.125 4.81894 19.1811 1.875 15.5625 1.875H8.4375Z"
                            fill="white"
                          />
                          <path
                            d="M15.5625 7.5H8.4375C7.91972 7.5 7.5 7.08028 7.5 6.5625C7.5 6.04472 7.91972 5.625 8.4375 5.625H15.5625C16.0803 5.625 16.5 6.04472 16.5 6.5625C16.5 7.08028 16.0803 7.5 15.5625 7.5Z"
                            fill="white"
                          />
                          <path
                            d="M15.5625 11.25H8.4375C7.91972 11.25 7.5 10.8303 7.5 10.3125C7.5 9.79472 7.91972 9.375 8.4375 9.375H15.5625C16.0803 9.375 16.5 9.79472 16.5 10.3125C16.5 10.8303 16.0803 11.25 15.5625 11.25Z"
                            fill="white"
                          />
                        </svg>
                      </div>
                      <p className=" text-[#504E4E]">{comment}</p>
                    </div>
                  ))}
                </div>
              </div>
                  ...
                  >
                    <div className="relative h-64 w-full">
                      ...
                      <div className="absolute top-4 left-4  text-white bg-[#F2EEEA] rounded-lg font-bold flex flex-col items-center">
                        <span className="bg-[#1C437F] px-[22px] rounded-[5px] py-[8px] text-[14px] leading-none">{post.day}</span>
                        <span className="px-4 py-1 rounded-[5px] text-[14px] bg-[#F2EEEA] text-[#17012C]">{post.month}</span>
                      </div>
                    </div>
                    <div className="pt-8">
                      ...
                      <h2 className="text-2xl font-bold text-[#17012C] py-4">
                        {post.title}
                      </h2>
                      <p className="text-[#504E4E] font-normal mb-6 line-clamp-3">
                        {post.description}
                      </p>
                      <button className="bg-[#1C437F] text-white font-semibold px-6 py-2 rounded-lg hover:bg-[#1C437F]/90 transition-colors">
                        Leia Mais
                      </button>
                      <div className="h-[1px] mt-8 bg-[#E4E4E4] w-full"></div>
                    </div>
                  </article>
                </>
              ))}
