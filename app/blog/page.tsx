        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid lg:grid-cols-3 gap-6 md:gap-8">
            ...
            <aside className={`lg:col-span-1 space-y-4 md:space-y-6 ${showFilters ? 'block' : 'hidden lg:block'}`}>
              {/* Search - Hidden on mobile (shown above) */}
                  ...
                  {latestPosts.map((post) => (
                    <div key={post.id} className="flex gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <h4 className="text-sm md:text-base font-semibold text-[#17012C] line-clamp-2">
                          {post.title}
                        </h4>
                      </div>
                    </div>
                    ...
                    <div key={index} className="flex items-start gap-3 md:gap-4">
                      <div className="bg-[#1C437F] rounded-full w-12 h-10 md:w-20 md:h-12 flex items-center justify-center shrink-0">
                        <svg
                          ...
                          fill="none"
                          xmlns="http://www.w3.org/2000/svg"
                          className="w-5 h-5 md:w-6 md:h-5"
                        >
                          <path
                ...
                >
                  <div className="relative h-48 md:h-64 w-full">
                    ...
                    <div className="absolute top-4 left-4 text-white bg-[#F2EEEA] rounded-lg font-bold flex flex-col items-center">
                      <span className="bg-[#1C437F] px-[18px] md:px-[22px] rounded-[5px] py-[6px] md:py-[8px] text-[12px] md:text-[14px] leading-none">{post.day}</span>
                      <span className="px-3 md:px-4 py-1 rounded-[5px] text-[12px] md:text-[14px] bg-[#F2EEEA] text-[#17012C]">{post.month}</span>
                    </div>
                  </div>
