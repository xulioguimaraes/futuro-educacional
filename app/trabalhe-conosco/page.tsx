        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 mb-8 md:mb-12 pt-4">
            {currentVacancies.map((job, index) => (
              ...
              >
                <h3 className="text-sm md:text-base font-bold text-black">{job.title}</h3>
                ...
                <button className="mx-0 md:mx-6 bg-[#1C437F] text-white font-bold py-2 px-4 rounded-lg hover:bg-[#1C437F]/90 transition-colors text-sm md:text-base">
                  Ver Vaga
                </button>
              </div>
            ))}
